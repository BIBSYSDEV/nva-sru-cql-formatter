...
public class TestCqlFormatter {
    ...
    public void assertReturnsCqlString() {
        ...
        assertEquals(cqlFormatter.format().getClass(), String.class);
    }
    ...
    public void assertReturnsCqlAuthorityQuery() {
        ...
        assertEquals(EXPECTED_AUTHORITY_ID_CQL + FAKE_AUTHORITY_ID, cqlFormatter.format());
    }
    ...
    public void assertReturnsCqlCreatorQuery() {
        ...
        assertEquals(EXPECTED_CREATOR_CQL + "\"" + FAKE_NAME + "\"", cqlFormatter.format());
    }
    ...
    public void assertReturnsCqlWithDateQuery() {
        ...
        assertEquals(expected, cqlFormatter.format());
    }
